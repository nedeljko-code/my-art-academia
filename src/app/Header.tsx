...
export default function Header({
  ...
  (activeLinkId && href.replace('/', '') === activeLinkId);
  ...
  return (
    <section className="h-full w-full bg-[#E8E6DF] flex flex-col gap-[clamp(8px,1vw,18px)]">
      ...
      <div
        className=" w-full h-[6vw] min-h-[56px]
...
"
          >
            ...
            >
              <a
                href="/behind"
                className={`hover:opacity-70 mr-[1vw] max-[600px]:mr-[6px] max-[450px]:mr-[4px]
              ${isTopActive("behind") ? "underline font-semibold" : ""}`}
              >
                Behind the Scenes
              </a>
              <a
                href="/reviews"
                className={`hover:opacity-70 mr-[1vw]
              ${isTopActive("reviews") ? "underline font-semibold" : ""}`}
              >
                Reviews
              </a>
              <a
                href="/faq"
                className={`hover:opacity-70 mr-[1vw]
              ${isTopActive("faq") ? "underline font-semibold" : ""}`}
              >
                FAQ
              </a>
            </nav>
            ...
            {/* MEMBERSHIP */}
            <div
              className="min-w-0 flex items-center justify-end pr-[4vw]
                  max-[600px]:pr-[1.2vw]"
            >
              <a
                href="/membership"
